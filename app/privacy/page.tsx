...
const sections = [
  ...
  },
  {
    ...
    body: "장학금·주거지원 신청 설계도에서 선택한 학적, 성적 구간, 가구·소득 구간, 주거 및 대출 조건은 서버로 전송하지 않고 사용 중인 브라우저의 로컬 저장소(localStorage)에만 저장합니다. 이름, 주민등록번호, 연락처, 증명서 파일은 입력받지 않습니다. 저장된 선택값은 각 설계도의 ‘입력 전체 삭제’ 기능 또는 브라우저의 사이트 데이터 삭제 기능으로 지울 때까지 해당 브라우저에 남을 수 있습니다.",
  },
  {
