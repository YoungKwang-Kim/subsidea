...
const sections = [
  ...
  {
    title: "2. 이용 목적",
    body: "문의 응답, 오류 제보 확인, 서비스 개선 요청 검토를 위해서만 정보를 이용합니다.",
  },
  {
    title: "3. 보관 기간",
    body: "문의 대응이 종료되었고 관련 법령 또는 분쟁 대응 목적의 보관 필요성이 없는 경우 합리적인 기간 내에 정보를 정리합니다.",
  },
  {
    title: "4. 제3자 제공",
    body: "법령에 따른 요청이 있는 경우를 제외하고, 사용자가 제공한 개인정보를 임의로 판매하거나 외부에 제공하지 않습니다.",
  },
];
